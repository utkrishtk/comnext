package org.utkrisht.ecom.controller;

import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import org.utkrisht.ecom.config.AppConstants;
import org.utkrisht.ecom.dto.ProductDto;
import org.utkrisht.ecom.dto.ProductResponse;
import org.utkrisht.ecom.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> createProduct(@RequestBody ProductDto dto, @PathVariable Long categoryId){
    ...
    public ResponseEntity<List<ProductDto>> getAllProducts(@RequestParam(name="pageSize", defaultValue = AppConstants.PAGE_SIZE) Integer pageSize,
    ...
    public ResponseEntity<List<ProductDto>> getProductByCategory(@PathVariable(name="categoryId")Long categoryId,
    ...
    public ResponseEntity<List<ProductDto>> getProductListByKeyword(@PathVariable(name="keyword") String keyword,
                                                                    @RequestParam(name="pageSize", defaultValue = AppConstants.PAGE_SIZE) Integer pageSize,
                                                                    @RequestParam(name="pageNumber", defaultValue = AppConstants.PAGE_NUMBER) Integer pageNumber,
                                                                    @RequestParam(name="sortBy", defaultValue = AppConstants.SORT_BY) String sortBy,
                                                                    @RequestParam(name="sortDir", defaultValue = AppConstants.SORT_DIR) String sortDir){
    ...
    public ResponseEntity<ProductDto> updateProduct(@PathVariable(name = "productId") Long productId,@RequestBody ProductDto dto){
